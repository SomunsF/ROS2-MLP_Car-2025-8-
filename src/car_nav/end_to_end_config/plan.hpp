...
protected:
  ...
  torch::Tensor prepareScanInput(const sensor_msgs::msg::LaserScan & scan);
  torch::Tensor prepareAuxInput(const sensor_msgs::msg::Imu & imu, const std::vector<float> & local_goal);
